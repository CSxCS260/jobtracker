...
const Home = () => {
    ...
    return (
        <div className="bg-blue-500 dark:bg-gray-900 h-fit ">
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg mb-10 mx-10">
                <div className="z-10 bg-white dark:bg-gray-800 flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            <Menu as="div" >
                                <div>
                                    <Menu.Button id="actionsDropdownButton" data-dropdown-toggle="actionsDropdown" class="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" type="button">
                            ...
                            <Menu as="div" >
                                <div>
                                    <Menu.Button id="filterDropdownButton" data-dropdown-toggle="filterDropdown" class="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" type="button">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 mr-2">
                ...
                <div className="">
                    <form autoComplete="off" onSubmit={handleSubmit} method='post'>
                        <table className="sticky top-[69.6px] table-fixed border-collapse overflow-hidden text-sm text-left rtl:text-right text-gray-500 dark:text-gray-100">
                            <thead className="w-full sticky top-[1.6px] z-10 rounded-lg text-xs text-gray-800 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
